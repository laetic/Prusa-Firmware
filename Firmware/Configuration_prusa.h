...
// Steps per unit {X,Y,Z,E}, X axis changed to steps per degree
#ifdef SNMM
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200/360,100,3200/8,140}
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200/360,100,3200/8,161.3}
#endif
...
#define X_MAX_POS 100000
#define X_MIN_POS -100000
